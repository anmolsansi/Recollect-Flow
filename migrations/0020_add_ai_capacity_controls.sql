...
CREATE TABLE ai_capacity_windows (
  ...
  provider_unit_limit INTEGER CHECK (provider_unit_limit IS NULL OR provider_unit_limit > 0),
  ...
  provider_units_reserved INTEGER NOT NULL DEFAULT 0 CHECK (provider_units_reserved >= 0),
  ...
  provider_units_consumed INTEGER NOT NULL DEFAULT 0 CHECK (provider_units_consumed >= 0),
...
CREATE TABLE ai_capacity_reservations (
  ...
  estimated_provider_units INTEGER NOT NULL DEFAULT 0 CHECK (estimated_provider_units >= 0),
  actual_request_units INTEGER CHECK (actual_request_units IS NULL OR actual_request_units >= 0),
